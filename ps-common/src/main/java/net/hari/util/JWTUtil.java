...
public class JWTUtil {
     ...
     * 加密的秘钥
     */
    private static final String SECRET = "hari.net666";

    /**
     * 令牌前缀
     */
    private static final String TOKEN_PREFIX = "paas-shop-0223";

    /**
     * subject
     */
    private static final String SUBJECT = "haripaas";
